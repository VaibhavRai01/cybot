        ...
        if interaction.user == self.user1:
            ...
            if duelrating is not None and (duelrating < 800 or duelrating > 3500 or duelrating % 100 != 0):
                ...
                if not unsolvedprobs:
                    ...
                    return
                unsolgiven = await random.choice(unsolvedprobs)
...
async def daily_problems():
    ...
    rating = await random.choice([800, 900, 1000])
    tags = []
    unsolved = get_user_unsolved_problems(solved, rating, tags)
    unsolved1 = await random.sample(unsolved, 2)
...
async def mashup(Interaction: discord.Interaction, p1: str, div: int):
    ...
    if div == 2:
        rating1 = await random.choice([800, 900, 1000])
        rating2 = await random.choice([1000, 1100, 1200])
        rating3 = await random.choice([1200, 1300, 1400])
        rating4 = await random.choice([1500, 1600, 1700])
        rating5 = await random.choice([1700, 1800, 1900])
        rating6 = await random.choice([2000, 2100, 2200])
        list = []
        problem1 = await random.choice(get_user_unsolved_problems(problemset, rating1, list))
        problem2 = await random.choice(get_user_unsolved_problems(problemset, rating2, list))
        problem3 = await random.choice(get_user_unsolved_problems(problemset, rating3, list))
        problem4 = await random.choice(get_user_unsolved_problems(problemset, rating4, list))
        problem5 = await random.choice(get_user_unsolved_problems(problemset, rating5, list))
        problem6 = await random.choice(get_user_unsolved_problems(problemset, rating6, list))
        ...
        rating1 = await random.choice([800, 900])
        rating2 = await random.choice([900, 1000])
        rating3 = await random.choice([1100, 1200, 1300])
        rating4 = await random.choice([1300, 1400])
        rating5 = await random.choice([1400, 1500, 1600])
        rating6 = await random.choice([1700, 1800])
        list = []
        problem1 = await random.choice(get_user_unsolved_problems(problemset, rating1, list))
        problem2 = await random.choice(get_user_unsolved_problems(problemset, rating2, list))
        problem3 = await random.choice(get_user_unsolved_problems(problemset, rating3, list))
        ...
        rating1 = await random.choice([800, 900])
        rating2 = await random.choice([800, 900])
        rating3 = await random.choice([1000, 1100])
        rating4 = await random.choice([1100, 1200])
        rating5 = await random.choice([1200, 1300])
        rating6 = await random.choice([1400, 1500])
        list = []
        problem1 = await random.choice(get_user_unsolved_problems(problemset, rating1, list))
        problem2 = await random.choice(get_user_unsolved_problems(problemset, rating2, list))
        problem3 = await random.choice(get_user_unsolved_problems(problemset, rating3, list))
